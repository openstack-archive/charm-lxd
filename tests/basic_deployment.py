...
class LXDBasicDeployment(OpenStackAmuletDeployment):
    ...
    def _configure_services(self):
        ...
        # Install the stable snap if xenial or later
        if CompareHostReleases(self.series) >= 'xenial':
            lxd_config['source'] = 'snap:stable'
        ...
        nova_config = {
            ...
            'virt-type': 'lxd',
            'openstack-origin': 'ppa:ajkavanagh/bionic-rocky-staging',
        }
